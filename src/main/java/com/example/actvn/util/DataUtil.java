...
//    public static String diaChinhChiTIet(String chiTiet, String diaChinh) {
//        if (!StringUtils.isEmpty(chiTiet) && !StringUtils.isEmpty(diaChinh)) {
//            return chiTiet + ", " + diaChinh;
//        } else if (StringUtils.isEmpty(chiTiet) && !StringUtils.isEmpty(diaChinh)) {
//            return diaChinh;
//        } else if (!StringUtils.isEmpty(chiTiet) && StringUtils.isEmpty(diaChinh)) {
//            return chiTiet;
//        }else {
